                ...
                <div className="main">
                    <aside>
                        <div className="sidebar left ">
                            ...
                            <li> <a href="/home"><i className="fa fa-th-large" /> <span className="nav-label" className='active'>Dashboards</span></a> </li>
                                ...
                                <li> <a href="/student"><i className="fa fa-diamond" /> <span className="nav-label">Quản ly học viên</span></a> </li>
                                ...
                                <li> <a href="#" data-toggle="collapse" data-target="#products" className="collapsed active"> <i className="fa fa-bar-chart-o" /> <span className="nav-label">Ứng dụng</span> <span className="fa fa-chevron-left pull-right" /> </a>
