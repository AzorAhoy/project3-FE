                ...
                <div className="main" id="mySidebar">
                        ...
                        <div className="sidebar left ">
                            ...
                            <ul className="list-sidebar bg-defoult">
                                ...
                                <li> <a href="/" data-toggle="collapse" data-target="#dashboard" className="collapsed active"> <i className="fas fa-address-book" /> <span className="nav-label"> Người Dùng</span> <span className="fa fa-chevron-left pull-right" /> </a>
                                ...
                                <li> <a href="#" data-toggle="collapse" data-target="#tables" className="collapsed active"><i className="fas fa-address-card" /> <span className="nav-label">Giáo Viên</span><span className="fa fa-chevron-left pull-right" /></a>
                                ...
                                <li> <a href="#" data-toggle="collapse" data-target="#region " className="collapsed active"><i className="fas fa-laptop-house" /> <span className="nav-label">Kho</span><span className="fa fa-chevron-left pull-right" /></a>
                                    <ul className="sub-menu collapse" id="#region ">
                                        <li><a href="/class"> Thêm Lớp Học</a></li>
                                        {/* <li><a href> Products list</a></li>
                                        <li><a href>Product edit</a></li>
                                        <li><a href> Product detail</a></li>
                                ...
                                <li> <a href="#" data-toggle="collapse" data-target="#endregion" className="collapsed active"><i className="fas fa-laptop-house" /> <span className="nav-label">Quản Lý Thiết Bị</span><span className="fa fa-chevron-left pull-right" /></a>
                                    <ul className="sub-menu collapse" id="#endregion">
                                        <li><a href="/class"> Thêm Lớp Học</a></li>
                                        {/* <li><a href> Products list</a></li>
                                        <li><a href>Product edit</a></li>
                                        <li><a href> Product detail</a></li>
                                 ...
                                 <li> <a href="/course"><i className="	fas fa-car" /> <span className="nav-label">Khóa Học</span></a> </li>
                                ...
                                <li className="nav-item">
                                    <a className="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                                        ...
                                        <span>Bộ Học Gõ Tốc Ký</span>
                                    </a>
                                    <div id="collapseTwo" className="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                                        <div class="bg-white py-2 collapse-inner rounded">
                                            <h6 className="collapse-header">Quy Tắc Gõ :</h6>
                                            <a className="collapse-item" href="amtiet.html">Âm Tiết</a>
                                            <a className="collapse-item" href="cards.html">Âm Đầu</a>
                                            <a className="collapse-item" href="buttons.html">Âm Chính</a>
                                            <a className="collapse-item" href="amcuoi.html">Âm Cuối</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
