            ...
            <>
                <div className="main" id="mySidebar">
                        ...
                        <div className="sidebar left ">
                            ...
                            <li> <a href="/home"><i className="	fas fa-home" /> <span className="nav-label">Dashboards</span></a> </li>
                                ...
                                <li> <a href="#" data-toggle="collapse" data-target="#e-commerce1" className="collapsed active"><i className="fas fa-laptop-house" /> <span className="nav-label">Quản Lý Khóa Học</span><span className="fa fa-chevron-left pull-right" /></a>
                                    <ul className="sub-menu collapse" id="e-commerce">
                                        <li><a href="/class"> Thêm Lớp Học</a></li>
                                        {/* <li><a href> Products list</a></li>
                                        <li><a href>Product edit</a></li>
                                ...
                                <li> <a href="/course"><i className="fa fa-pie-chart" /> <span className="nav-label">Hộp Thư</span> </a></li>
