                    ...
                    <aside>
                        <div className="sidebar left ">
                            ...
                            <li> <a href="/home"><i className="fa fa-th-large" /> <span className="nav-label">Trang Chủ</span></a> </li>
                                ...
                                <li> <a href="/lichhoc"><i className="fas fa-cogs" /> <span className="nav-label">Lịch Dạy</span></a> </li>
                                <li> <a href="/điemanh"><i className="fas fa-shapes" /> <span className="nav-label">Điểm Danh</span> </a></li>
                                <li> <a href="/dangkylop"><i className="fa fa-address-book" /> <span className="nav-label">Đăng Ký Lớp</span> </a></li>
                                <li> <a href="/thanhtoanhocphi"><i className="fab fa-alipay" /> <span className="nav-label">Thanh Toán Học Phí</span> </a></li>
                                <li> <a href="/aaa" data-toggle="collapse" data-target="#products" className="collapsed active"> <i className="fa fa-address-book" /> <span className="nav-label">Kết Quả Học Tập</span> <span className="fa fa-chevron-left pull-right" /> </a>
                                    <ul className="sub-menu collapse" id="products">
                                        <li className="active"><a href="/bangdiem">Chấm Điểm </a></li>
