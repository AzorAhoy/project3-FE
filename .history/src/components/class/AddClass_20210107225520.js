                                ...
                                <div className="modal-body">
                                    <form >
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="text" className="form-control" id="startDate" name="startDate"  onChange={this.handleChange}/>
                                        </div>
                                        <div className="form-group">
                                            <label htmlFor="message-text" className="col-form-label">Ngày Kết Thúc:</label>
                                            <input type="text" className="form-control" id="endDate" name="endDate"  onChange={this.handleChange}/>
                                        </div>
                                        {/* <div className="form-group">
