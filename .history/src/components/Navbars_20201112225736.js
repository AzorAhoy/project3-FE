                        ...
                        <div className="sidebar left ">
                            <div className="user-panel">
                                ...
                                <div className="pull-left info">
                                    ...
                                    <a href="/student"><i className="fa fa-circle text-success" /> Online</a>
                                </div>
                            </div>
                            <ul className="list-sidebar bg-defoult">
                            <li> <a href="/"><i className="fa fa-th-large" /> <span className="nav-label">Dashboards</span></a> </li>
                                ...
                                <li> <a href="/home"><i className="fa fa-diamond" /> <span className="nav-label">Quản ly học viên</span></a> </li>
                                <li> <a href="/teacher"><i className="fa fa-files-o" /> <span className="nav-label">Quản lý giáo viên</span></a> </li>
                                <li> <a href="/studen"><i className="fa fa-files-o" /> <span className="nav-label">Other Pages</span></a> </li>
