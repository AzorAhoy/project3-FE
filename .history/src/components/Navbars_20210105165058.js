                ...
                <div className="main" id="mySidebar">
                        ...
                        <div className="sidebar left ">
                            ...
                            <ul className="list-sidebar bg-defoult">
                                ...
                                <li> <a href="#" data-toggle="collapse" data-target="#tablestwo" className="collapsed active"><i className="fas fa-laptop-house" /> <span className="nav-label">Kho</span><span className="fa fa-chevron-left pull-right" /></a>
                                    <ul className="sub-menu collapse" id="#tablestwo">
                                        <li><a href="/class"> Thêm Lớp Học</a></li>
                                        {/* <li><a href> Products list</a></li>
                                        <li><a href>Product edit</a></li>
                                        <li><a href> Product detail</a></li>
                                ...
                                <li> <a href="#" data-toggle="collapse" data-target="#e-commercetwo" className="collapsed active"><i className="fas fa-laptop-house" /> <span className="nav-label">Quản Lý Thiết Bị</span><span className="fa fa-chevron-left pull-right" /></a>
                                    <ul className="sub-menu collapse" id="#e-commercetwo">
                                        <li><a href="/class"> Thêm Lớp Học</a></li>
                                        {/* <li><a href> Products list</a></li>
                                        <li><a href>Product edit</a></li>
                                        <li><a href> Product detail</a></li>
