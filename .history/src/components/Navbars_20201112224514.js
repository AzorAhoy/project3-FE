                    ...
                    <aside>
                        <div className="sidebar left ">
                            ...
                            <li> <a href="/"><i className="fa fa-th-large" /> <span className="nav-label">Dashboards</span></a> </li>
                                ...
                                <li> <a href="/home"><i className="fa fa-diamond" /> <span className="nav-label">Quản lí học viên</span></a> </li>
                                <li> <a href="#"><i className="fa fa-files-o" /> <span className="nav-label">Quản lý giáo viên</span></a> </li>
