                                ...
                                <div className="modal-body">
                                    <form >
                                        <div className="form-group">
                                            ...
                                            <input type="text" name="name" className="form-control" id="name" value={this.props.studentInfo.name} />
                                        </div>
                                        <div className="form-group">
                                            <label htmlFor="message-text" className="col-form-label">Email:</label>
                                            <input type="text" className="form-control" id="email" name="email" value={this.props.studentInfo.email} />
                                        </div>

                                        <div className="form-group">
                                            <label htmlFor="password" className="col-form-label">Ngày Tạo:</label>
                                            <input type="password" className="form-control" id="password" name="password" value={this.props.studentInfo.createdAt} />
                                        </div>
                                    </form>
                                </div>
