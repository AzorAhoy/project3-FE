                                ...
                                <div className="modal-body">
                                    <form >
                                        <div className="form-group">
                                            ...
                                            <input type="text" name="name" className="form-control"   value={this.state.name} onChange={(e) => {
                                                this.handleChange(e)
                                            }} />
                                        </div>
                                        <div className="form-group">
                                            <label   className="col-form-label">Email:</label>
                                            <input type="text" className="form-control"   name="email" value={this.state.email} onChange={(e) => {
                                                this.handleChange(e)
                                            }} />
                                        </div>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="datetime" className="form-control"  name="creatAt" value={this.state.lastUpdate} onChange={(e) => {
                                                this.handleChange(e)
                                            }} />
                                        </div>
                                    </form>
