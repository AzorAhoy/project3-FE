                    ...
                    <aside>
                        <div className="sidebar left ">
                            ...
                            <ul className="list-sidebar bg-defoult">
                                ...
                                <li> <a href="/aaa" data-toggle="collapse" data-target="#products" className="collapsed active"> <i className="fa fa-diamond" /> <span className="nav-label">Học Viên</span> <span className="fa fa-chevron-left pull-right" /> </a>
