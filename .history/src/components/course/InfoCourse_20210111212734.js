                            ...
                            <div className="modal-body">
                                <form >
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" name="subject" value={infor.email} onChange={(e) => {
                                            handleChange(e)
                                        }} />
                                    </div>
                                    <div className="form-group">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="datetime" className="form-control" name="endDate" value={userInfo.endDate} onChange={(e) => {
                                            handleChange(e)
                                        }} />
                                    </div>
                                </form>
