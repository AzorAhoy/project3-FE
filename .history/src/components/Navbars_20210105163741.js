                ...
                <div className="main" id="mySidebar">
                        ...
                        <div className="sidebar left ">
                            ...
                            <li> <a href="/home"><i className="	fas fa-home" /> <span className="nav-label">Trang Chủ</span></a> </li>
                                ...
                                <li> <a href="#" data-toggle="collapse" data-target="#1" className="collapsed active"><i className="fas fa-laptop-house" /> <span className="nav-label">Kho</span><span className="fa fa-chevron-left pull-right" /></a>
                                    <ul className="sub-menu collapse" id="#1">
                                        <li><a href="/class"> Thêm Lớp Học</a></li>
                                        {/* <li><a href> Products list</a></li>
                                        <li><a href>Product edit</a></li>
                                        <li><a href> Product detail</a></li>
                                ...
                                <li> <a href="#" data-toggle="collapse" data-target="#" className="collapsed active"><i className="fas fa-laptop-house" /> <span className="nav-label">Quản Lý Thiết Bị</span><span className="fa fa-chevron-left pull-right" /></a>
